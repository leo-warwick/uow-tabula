...
class CombinedStudentTimetableEventSourceTest extends TestBase with Mockito {
  ...
  val ttEvent = TimetableEvent("", "From Timetable", "", "", TimetableEventType.Induction, Nil, DayOfWeek.Monday, startTime, endTime, None, None, None, TimetableEvent.Parent(), None, Nil, Nil, AcademicYear(2013), None, Map(), None, None)
  val timetableEvents = Seq(ttEvent)

  val sgEvent = TimetableEvent("", "From Group", "", "", TimetableEventType.Induction, Nil, DayOfWeek.Tuesday, startTime, endTime, None, None, None, TimetableEvent.Parent(), None, Nil, Nil, AcademicYear(2013), None, Map(), None, None)
